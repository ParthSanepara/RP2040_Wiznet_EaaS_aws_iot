...
#ifndef _PORT_CORE_HTTP_CONFIG_H_
#define _PORT_CORE_HTTP_CONFIG_H_
...
#define HTTP_PATH_MAX_SIZE   2048
#define HTTP_URL_MAX_SIZE    ( HTTP_DOMAIN_MAX_SIZE + HTTP_PATH_MAX_SIZE )
